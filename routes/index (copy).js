...
(async function example() {
  ...
  try {
    ...
    await driver.findElements(By.css("div.s3ARzb.eejsDc.ddc5Hb div.MkjOTb.oKubKe.zpVKtf")).then(elements => {
      ...
      const forLoop = async _ => {
        for (i = 1; i <= elements.length; i++) {
          ...
          // console.log('aapp '+parseInt(myDataMeta[myDataMeta.length -1]));
          ...
          // const forLoopMobile = async _ => {
              // for (i = 1; i <= 2; i++) {
              //   var myDataMetaMobile = await driver.findElement(By.css("div.CtOYUe.I4chsf.VJARVc.RtPpqe table.i3WFpf tbody tr:nth-child("+i+") td.XgRaPc.AB6Eee.QNcORc.csDJwd.LoCYSb.Bj8DDb.sbEvHd span.zRhise")).getText();
    ...
    // for (i = 1; i <= elements.length; i++) {
    //     await driver.findElement(By.css("div.s3ARzb.eejsDc.ddc5Hb div:nth-child("+i+") div.iPVm1b.cgo1ib div.utePyc")).click();
    // }


    // MkjOTb oKubKe zpVKtf
    //
    // await sleep.sleep(2);
    //
    //
